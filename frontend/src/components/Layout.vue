            ...
            <div :class="[
                ...
                <div class="flex h-16 items-center justify-between px-6 border-b border-gray-200/80 bg-white/50">
                    <a href="#" class="flex items-center space-x-3">
                        <img class="h-12 w-auto" src="../assets/logo.svg" alt="Chat App" />
                ...
                <nav class="flex flex-col h-[calc(100vh-4rem)] p-4">
                    <!-- User Profile -->
                    <div class="flex items-center space-x-4 px-4 py-2 mb-4 border-b border-gray-200/80">
                        <img v-if="fullAvatarUrl" :src="fullAvatarUrl" alt="Profile Image"
                    ...
                    <!-- Main Navigation -->
                    <div class="space-y-1">
                        <button v-for="item in navigationItems" :key="item.name" @click="setCurrentView(item.name)"
                            :class="[
                                'flex w-full items-center space-x-2 rounded-lg px-3 py-2 text-sm font-medium transition-colors duration-200',
                    ...
                    <!-- Logout -->
                    <div class="mt-auto border-t border-gray-200/80 pt-4 space-y-2">
